        ...
        <div id='form-multiple' className='card mb-5 mb-xl-10'>
            <div className="card-header" style={{ backgroundColor: "purple" }}>
                <div className="card-title">
                    <h3 className='text-light'>Widget Two</h3>
                </div>
            </div>
            <div className="card-body p-0">
                <form method="post" autoComplete='off' onSubmit={(e) => handlerSubmit(e)}>
                            ...
                            <tr>
                                <td colSpan={5}>
                                    <button className="btn btn-sm btn-light-primary" type='button' onClick={() => setPostData(prev => {
                                        ...
                                        <h8 className='btn btn-xs fw-bold text-light' style={{ backgroundColor: "purple" }} >+ Tambah Tabel</h8>
                                    </button>
                                </td>
                            </tr>
                        </tfoot>
                    ...
                    <div className="text-end p-10 mb-3" style={{ backgroundColor: "purple" }}>
